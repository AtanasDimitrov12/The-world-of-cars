...
namespace InterfaceLayer
{
    public interface IPeopleDataWriter
    {
        ...
        string AddAdmin(string Username, string email, string password, string PhoneNumber, DateTime CreatedOn, string PassSalt);
        string UpdateUser(int userId, string Username, string email, string password, int licenseNumber, DateTime CreatedOn);
        string UpdateAdministration(int adminId, string username, string email, string passwordHash, string phoneNumber, DateTime createdOn, string PassSalt);
